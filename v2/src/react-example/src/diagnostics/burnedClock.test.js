...
describe('formatClock', () => {
  /*
   * Local time, because the two screens being compared are in front of one person, and to the
   * millisecond, because the range this is used in is under a second.
   */
...
describe('when the browser cannot do it', () => {
  ...
  /*
   * A caller that skips the check still gets a working publish. A diagnostic that takes the
   * video away when it cannot run is worse than one that quietly does nothing.
   */
