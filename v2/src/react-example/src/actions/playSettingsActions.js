...
export const SET_PLAY_TURN_SERVER_URL = 'SET_PLAY_TURN_SERVER_URL';
export const SET_PLAY_TURN_USERNAME = 'SET_PLAY_TURN_USERNAME';
export const SET_PLAY_TURN_PASSWORD = 'SET_PLAY_TURN_PASSWORD';
...
export const SET_PLAY_DATA_CHANNELS_ENABLED = 'SET_PLAY_DATA_CHANNELS_ENABLED';
