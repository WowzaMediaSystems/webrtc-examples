...
export const SET_PUBLISH_LATENCY_PROBE = 'SET_PUBLISH_LATENCY_PROBE';
export const SET_PUBLISH_BURNED_CLOCK = 'SET_PUBLISH_BURNED_CLOCK';
export const SET_PUBLISH_USE_SIMULCAST = 'SET_PUBLISH_USE_SIMULCAST';
export const SET_PUBLISH_SIMULCAST_RENDITIONS = 'SET_PUBLISH_SIMULCAST_RENDITIONS';
export const SET_PUBLISH_CHAT_ENABLED = 'SET_PUBLISH_CHAT_ENABLED';
export const SET_PUBLISH_CAPTIONS_ENABLED = 'SET_PUBLISH_CAPTIONS_ENABLED';
