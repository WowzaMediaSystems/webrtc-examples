...
describe('encode and decode', () => {
  ...
  /*
   * A wrong number is worse than no number: it would be reported as a latency and believed.
   * So a corrupted read has to fail the check rather than round to something plausible.
   */
  ...
  // Compression washes the blacks and whites towards the middle; the midpoint is derived
  // from the references in the same row, so a washed-out read still decodes.
