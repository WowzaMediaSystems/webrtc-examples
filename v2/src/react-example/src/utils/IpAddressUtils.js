/*
 * Client IP validation for the secure-token fields.
 *
 * The Engine wants a bare address, so anything carrying a port, a CIDR suffix, a scheme or
 * brackets is rejected here rather than sent and refused later. Both families are accepted:
 * a viewer reached over IPv6 has an IPv6 address and the token has to match it.
 */
