...
/*
 * Single-series trend line for a stat tile.
 *
 * One series, so no legend: the tile's label names it. The line uses the de-emphasis
 * hue and only the current point carries the accent, so the eye lands on "now" while the
 * history stays context. No axes or gridlines at this size; the tile's value is the
 * readable number and the line is shape only.
 */
