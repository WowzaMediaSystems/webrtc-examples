...
/*
 * What the readings mean, behind a button.
 *
 * Written for whichever page it is opened from. The player page shows one round trip, the
 * combined page shows two, and the text has to hold either way, so it says what a round trip
 * is rather than describing a particular screen.
 *
 * A <dialog> rather than a div: modal behaviour, focus containment, Escape to close and the
 * backdrop all come from the element.
 */
